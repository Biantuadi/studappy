...
const types = [
  {
    name: "Marques",
    emoji: "👟",
    animatedEmoji: "https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Running%20Shoe.png",
  },
  {
    name: "MarketPlace",
    emoji: "🛒",
  ...
  },
  {
    name: "Tech",
    emoji: "💻",
    animatedEmoji: "https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Laptop.png",
  },
];
...
export default function EshopScreen() {
  ...
  const renderCompanyItem = useCallback(({ item }:any) => (
    <CompanyItem
      imageUri={item.image}
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: mainTheme.colors.white }}>
      <EshopContainer>
        ...
        <Header>
          <BackButton styleBackButton={{ marginTop: 0, marginLeft: 0, marginBottom: 10 }} />
          <Greeting>Votre</Greeting>
          <HeartContainer>
            <Greeting>Coup de cœur</Greeting>
            <HeartIcon source={{ uri: "https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Beating%20Heart.png" }} />
          </HeartContainer>
        </Header>

        <SearchContainer>
          <SearchInput placeholder="Taper" />
          <SearchIcon source={{ uri: "https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Magnifying%20Glass%20Tilted%20Left.png" }} />
        </SearchContainer>
          ...
          ListHeaderComponent={
            <>
              ...
              <PopularContainer>
                ...
                <PopularIcon source={{ uri: types[selectedType].animatedEmoji }} />
              </PopularContainer>
            </>
          }
          data={getCompanies()}
...
const TypeCard = styled.TouchableOpacity<{ selected: boolean }>`
  ...
  border-radius: 7px;
  padding: 8px 12px;
  background-color: ${({ selected }) => (selected ? mainTheme.colors.primary : mainTheme.colors.white)};
`;

const TypeText = styled.Text<{ selected: boolean }>`
  font-size: 13px;
  color: ${({ selected }) => (selected ? mainTheme.colors.white : mainTheme.colors.primary)};
`;
